import svgPaths from "./svg-x7w1n2bjd3";
import imgImage7 from "figma:asset/a5fe14a57e84bf094609cc85f4bc6dc50966249b.png";
...
function Link() {
  return (
    <div className="absolute left-[679.18px] size-[38px] top-[160.01px]" data-name="Link">
...
function Heading() {
  return (
    <div className="absolute h-[212.784px] left-[48px] top-[159.99px] w-[1184.006px]" data-name="Heading 1">
      <p className="absolute font-['Space_Grotesk:Bold',sans-serif] font-bold leading-[106.4px] left-0 text-[112px] text-white top-[-0.18px] tracking-[-3.36px] w-[795px]">Marketplace de Vehículos</p>
      <Link />
    </div>
  );
}
...
function Paragraph1() {
  return (
    <div className="absolute h-[125.057px] left-[48px] top-[404.76px] w-[671.989px]" data-name="Paragraph">
      <p className="absolute font-['Space_Grotesk:Medium',sans-serif] font-medium leading-[22.4px] left-0 text-[18px] text-[rgba(255,255,255,0.45)] top-[-0.36px] w-[654px]">Developing a visual and interactive vehicle marketplace experience within gtc.com.gt that allows users to fully explore the journey—from browsing the landing page to selecting a new vehicle, requesting a quote, and completing an immediate prequalification.</p>
    </div>
  );
}
...
function Container() {
  return (
    <div className="absolute h-[25.795px] left-[48px] top-[561.8px] w-[1184.006px]" data-name="Container">
      <Text />
      <Text1 />
      <Text2 />
      <Text3 />
...
function Section() {
  return (
    <div className="absolute h-[651.591px] left-[91.82px] top-0 w-[1280px]" data-name="Section">
      <Paragraph />
      <Heading />
      <Paragraph1 />
      <Container />
...
function ImageMarketplaceDeVehiculos() {
  return (
    <div className="absolute h-[600px] left-0 overflow-clip top-[651.59px] w-[1463.636px]" data-name="Image (Marketplace de Vehículos)">
      <div className="absolute h-[1195px] left-0 top-[0.41px] w-[1464px]" data-name="image 7">
  ...
  return (
    <div className="h-[95.98px] relative shrink-0 w-[572.358px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[7.997px] items-start relative size-full">
        ...
        <p className="font-['Space_Grotesk:Bold',sans-serif] font-bold leading-[72px] relative shrink-0 text-[48px] text-white tracking-[-0.96px] whitespace-nowrap">Vivienda GTC</p>
      </div>
    </div>
  );
}
...
function Container2() {
  return (
    <div className="bg-[#4dffd2] relative rounded-[30504000px] shrink-0 size-[47.997px]" data-name="Container">
...
function CaseStudy() {
  return (
    <div className="absolute bg-[#0a0a0a] h-[2573px] left-0 top-0 w-[1464px]" data-name="CaseStudy">
      <Section />
      <ImageMarketplaceDeVehiculos />
      <div className="absolute content-stretch flex h-[84.886px] items-center justify-between left-[91.82px] pt-[0.909px] px-[47.997px] top-[2488.11px] w-[1280px]" data-name="Footer">
      ...
      <div className="absolute bg-[#0a0a0a] content-stretch flex flex-col h-[224.872px] items-start left-0 pt-[0.909px] px-[91.818px] top-[2263.24px] w-[1463.636px]" data-name="Section">
        <div aria-hidden="true" className="absolute border-[rgba(255,255,255,0.1)] border-solid border-t-[0.909px] inset-0 pointer-events-none" />
        <Button />
      </div>
    </div>
...
function Text6() {
  return (
    <div className="h-[20px] relative shrink-0 w-[60.014px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Space_Mono:Regular',sans-serif] leading-[20px] left-0 not-italic text-[14px] text-[rgba(255,255,255,0.3)] top-[0.09px] whitespace-nowrap">02 / 04</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-full" data-name="Container">
      ...
      <div className="font-['Space_Grotesk:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[16.8px] text-[rgba(255,255,255,0.7)] w-[764px] whitespace-pre-wrap">
        <p className="leading-[30.24px] mb-0">The Vehicle Marketplace is a visual and interactive experience designed within gtc.com.gt to allow users to fully explore the vehicle purchasing journey—from initial browsing to quotation and immediate prequalification. The platform supports both exploratory users with no purchase intent and users ready to select a vehicle and start a financial process.</p>
        <p className="leading-[30.24px] mb-0">&nbsp;</p>
        <p className="leading-[30.24px]">The solution prioritizes clarity, personalization, and guided decision‑making across the entire experience.</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-full" data-name="Container">
      ...
      <div className="font-['Space_Grotesk:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[16.8px] text-[rgba(255,255,255,0.7)] w-[716px] whitespace-pre-wrap">
        <p className="leading-[30.24px] mb-0">Users interested in purchasing a vehicle faced fragmented journeys, limited financial visibility, and unclear paths between exploration and formal acquisition. There was a need to validate whether users could confidently move from browsing to prequalification without friction, confusion, or early abandonment.</p>
        <p className="leading-[30.24px] mb-0">&nbsp;</p>
        <p className="leading-[30.24px]">Additionally, the marketplace needed to support multiple user intents—casual exploration, comparison, financial simulation, and i</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-full" data-name="Container">
      ...
      <div className="font-['Space_Grotesk:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[16.8px] text-[rgba(255,255,255,0.7)] w-[748px] whitespace-pre-wrap">
        <p className="leading-[30.24px] mb-0">I designed a flexible, scenario‑based experience that adapts to different levels of user intent. The platform guides users through vehicle discovery using relevant filters, detailed listings, and comparison tools, while enabling quota simulations and immediate prequalification at multiple points in the journey.</p>
        <p className="leading-[30.24px] mb-0">&nbsp;</p>
        <p className="leading-[30.24px]">Complementary flows were also designed to support the ecosystem, including onboarding forms for partner dealerships and appointment scheduling with advisors, ensuring a connected and scalable marketplace experience.</p>
      </div>
    </div>
  );
}
...
function Section1() {
  return (
    <div className="absolute h-[862px] left-[140px] top-[1310px] w-[1184px]" data-name="Section">
      <Container5 />
      <Container12 />
    </div>
  );
