import svgPaths from "./svg-p202np8cht";
import imgImage9 from "figma:asset/8e12ad280096f8f1a2b7a740b369c1d92cc6080b.png";
...
function Link() {
  return (
    <div className="absolute left-[801.18px] size-[38px] top-[54.01px]" data-name="Link">
...
function Heading() {
  return (
    <div className="absolute h-[106.392px] left-[48px] top-[159.99px] w-[1184.006px]" data-name="Heading 1">
      <p className="absolute font-['Space_Grotesk:Bold',sans-serif] font-bold leading-[106.4px] left-0 text-[112px] text-white top-[-0.18px] tracking-[-3.36px] whitespace-nowrap">Tipo de Cambio</p>
      <Link />
    </div>
  );
}
...
function Paragraph1() {
  return (
    <div className="absolute h-[93.793px] left-[48px] top-[298.37px] w-[671.989px]" data-name="Paragraph">
      <p className="absolute font-['Space_Grotesk:Regular',sans-serif] font-normal leading-[31.28px] left-0 text-[18.4px] text-[rgba(255,255,255,0.6)] top-[-0.36px] w-[667px]">Designing a dedicated section to display the real‑time exchange rate from US dollars to Guatemalan quetzals, providing clear and accessible currency conversion information.</p>
    </div>
  );
}
...
function Container2() {
  return <div className="absolute bg-[#c4b5fd] h-[3.991px] left-0 top-[600px] w-[1463.636px]" data-name="Container" />;
}

function ImageTipoDeCambio() {
  return <div className="absolute h-[600px] left-0 top-0 w-[1463.636px]" data-name="Image (Tipo de Cambio)" />;
}
...
function Container1() {
  return (
    <div className="absolute h-[600px] left-0 overflow-clip top-[513.93px] w-[1463.636px]" data-name="Container">
      <Container2 />
      <ImageTipoDeCambio />
      <div className="absolute h-[1015px] left-[-12px] top-[-207.93px] w-[1476px]" data-name="image 9">
  ...
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-full" data-name="Container">
      ...
      <div className="font-['Space_Grotesk:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[16.8px] text-[rgba(255,255,255,0.7)] w-[716px] whitespace-pre-wrap">
        <p className="leading-[30.24px] mb-0">Users needed a simple and trustworthy way to check the current exchange rate without leaving the platform or navigating complex financial tools. Existing solutions were either hidden, unintuitive, or overloaded with unnecessary information.</p>
        <p className="leading-[30.24px] mb-0">&nbsp;</p>
        <p className="leading-[30.24px]">The main challenge was to surface critical exchange rate data clearly, ensuring accuracy, readability, and contextual relevance without adding friction to the user experience.</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-full" data-name="Container">
      ...
      <div className="font-['Space_Grotesk:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[16.8px] text-[rgba(255,255,255,0.7)] w-[748px] whitespace-pre-wrap">
        <p className="leading-[30.24px] mb-0">I designed a focused, low‑friction interface that prioritizes clarity and visibility of the exchange rate. The section was structured to present essential information at a glance, using clear hierarchy, concise labeling, and consistent formatting aligned with the overall product design system.</p>
        <p className="leading-[30.24px] mb-0">&nbsp;</p>
        <p className="leading-[30.24px]">The solution was built to integrate seamlessly into the platform, supporting future scalability and potential expansion into additional currencies or financial tools.</p>
      </div>
    </div>
  );
}
...
function Container12() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-0 pt-[26px] top-[352px] w-[352.017px]" data-name="Container">
...
function Section1() {
  return (
    <div className="absolute h-[862px] left-[140px] top-[1216px] w-[1184px]" data-name="Section">
      <Container3 />
      <Container10 />
    </div>
  );
...
function CaseStudy() {
  return (
    <div className="absolute bg-[#0a0a0a] h-[2458px] left-0 top-0 w-[1464px]" data-name="CaseStudy">
      <Section />
      <Container1 />
      <Section1 />
      <div className="absolute content-stretch flex h-[84.886px] items-center justify-between left-[91.82px] pt-[0.909px] px-[47.997px] top-[2372.87px] w-[1280px]" data-name="Footer">
        <div aria-hidden="true" className="absolute border-[rgba(255,255,255,0.1)] border-solid border-t-[0.909px] inset-0 pointer-events-none" />
        <Link1 />
        <Text13 />
      </div>
...
function Text15() {
  return (
    <div className="h-[20px] relative shrink-0 w-[60.014px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Space_Mono:Regular',sans-serif] leading-[20px] left-0 not-italic text-[14px] text-[rgba(255,255,255,0.3)] top-[0.09px] whitespace-nowrap">04 / 04</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[95.98px] relative shrink-0 w-[572.358px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[7.997px] items-start relative size-full">
        ...
        <p className="font-['Space_Grotesk:Bold',sans-serif] font-bold leading-[72px] relative shrink-0 text-[48px] text-white tracking-[-0.96px] whitespace-nowrap">Portal Archivo</p>
      </div>
    </div>
  );
}
...
function Container19() {
  return (
    <div className="bg-[#e8ff4d] relative rounded-[30504000px] shrink-0 size-[47.997px]" data-name="Container">
...
export default function PortfolioLandingPageCopy() {
  return (
    <div className="bg-white relative size-full" data-name="Portfolio landing page (Copy)">
      ...
      <Navbar />
      <CaseStudy1 />
      <div className="absolute bg-[#0a0a0a] content-stretch flex flex-col h-[224.872px] items-start left-0 pt-[0.909px] px-[91.818px] top-[2148px] w-[1463.636px]" data-name="Section">
        <div aria-hidden="true" className="absolute border-[rgba(255,255,255,0.1)] border-solid border-t-[0.909px] inset-0 pointer-events-none" />
        <Button4 />
      </div>
    </div>
