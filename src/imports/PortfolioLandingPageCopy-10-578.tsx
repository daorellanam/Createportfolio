...
function Paragraph() {
  return (
    <div className="absolute content-stretch flex h-[15.994px] items-start left-[48px] top-[128px] w-[1184.006px]" data-name="Paragraph">
      <p className="flex-[1_0_0] font-['Space_Grotesk:Regular',sans-serif] font-normal leading-[16px] min-h-px min-w-px relative text-[12px] text-[rgba(255,255,255,0.3)] tracking-[1.92px] uppercase">UX UI Design · Product Design · 2026</p>
    </div>
  );
}
...
function Link() {
  return (
    <div className="absolute left-[728.18px] size-[38px] top-[54.01px]" data-name="Link">
...
function Heading() {
  return (
    <div className="absolute h-[106.392px] left-[48px] top-[159.99px] w-[1184.006px]" data-name="Heading 1">
      <p className="absolute font-['Space_Grotesk:Bold',sans-serif] font-bold leading-[106.4px] left-0 text-[112px] text-white top-[-0.18px] tracking-[-3.36px] whitespace-nowrap">Portal Archivo</p>
      <Link />
    </div>
  );
}
...
function Paragraph1() {
  return (
    <div className="absolute h-[62.528px] left-[48px] top-[298.37px] w-[671.989px]" data-name="Paragraph">
      <p className="absolute font-['Space_Grotesk:Medium',sans-serif] font-medium leading-[22.4px] left-0 text-[18px] text-[rgba(255,255,255,0.45)] top-[-13.37px] w-[658px]">Designing a digital interface that automates and transforms manual processes into integrated digital workflows, enabling end‑to‑end management, traceability, and compliance of both physical and digital documents.</p>
    </div>
  );
}
...
function Text() {
  return (
    <div className="absolute border-[0.909px] border-[rgba(255,255,255,0.2)] border-solid h-[25.795px] left-0 top-0 w-[116.889px]" data-name="Text">
      <p className="absolute font-['Space_Grotesk:Regular',sans-serif] font-normal leading-[16px] left-[11.99px] text-[12px] text-[rgba(255,255,255,0.5)] top-[3.99px] tracking-[1.2px] uppercase whitespace-nowrap">UX Research</p>
    </div>
  );
}
...
function Text1() {
  return (
    <div className="absolute border-[0.909px] border-[rgba(255,255,255,0.2)] border-solid h-[25.795px] left-[124.89px] top-0 w-[54.602px]" data-name="Text">
...
function Text2() {
  return (
    <div className="absolute border-[0.909px] border-[rgba(255,255,255,0.2)] border-solid h-[25.795px] left-[187.49px] top-0 w-[107.173px]" data-name="Text">
...
function Text3() {
  return (
    <div className="absolute border-[0.909px] border-[rgba(255,255,255,0.2)] border-solid h-[25.795px] left-[302.66px] top-0 w-[139.29px]" data-name="Text">
...
function Container() {
  return (
    <div className="absolute h-[25.795px] left-[48px] top-[392.88px] w-[1184.006px]" data-name="Container">
      <Text />
      <Text1 />
      <Text2 />
      <Text3 />
...
function Section() {
  return (
    <div className="absolute h-[482.67px] left-[91.82px] top-0 w-[1280px]" data-name="Section">
      <Paragraph />
      <Heading />
      <Paragraph1 />
      <Container />
...
function Container2() {
  return <div className="absolute bg-[#e8ff4d] h-[3.991px] left-0 top-[600px] w-[1463.636px]" data-name="Container" />;
}

function ImagePortalArchivo() {
  return (
    <div className="absolute h-[600px] left-0 overflow-clip top-0 w-[1463.636px]" data-name="Image (Portal Archivo)">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImagePortalArchivo} />
      <div className="absolute h-[992px] left-0 top-[-66.67px] w-[1464px]" data-name="image 6">
...
function Container1() {
  return (
    <div className="absolute h-[600px] left-0 overflow-clip top-[482.67px] w-[1463.636px]" data-name="Container">
      <Container2 />
      <ImagePortalArchivo />
    </div>
  );
  ...
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-full" data-name="Container">
      ...
      <div className="font-['Space_Grotesk:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[16.8px] text-[rgba(255,255,255,0.7)] w-[764px] whitespace-pre-wrap">
        <p className="leading-[30.24px] mb-0">Portal Archivo is a digital document management platform designed to transform manual archival processes into a centralized, traceable, and fully digital workflow. The product enables end‑to‑end management of document storage, loans, returns, and access control for both physical and digital files, ensuring operational efficiency and regulatory compliance.</p>
        <p className="leading-[30.24px] mb-0">&nbsp;</p>
        <p className="leading-[30.24px]">The platform guides users through each step of the document lifecycle, reducing friction while maintaining strict control over sensitive information.</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-full" data-name="Container">
      ...
      <div className="font-['Space_Grotesk:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[16.8px] text-[rgba(255,255,255,0.7)] w-[716px] whitespace-pre-wrap">
        <p className="leading-[30.24px] mb-0">Document management processes were fragmented and heavily dependent on manual steps, creating inefficiencies, limited traceability, and high operational risk. The lack of a unified system made it difficult to manage document storage, track physical movements, and control access across different user roles.</p>
        <p className="leading-[30.24px] mb-0">&nbsp;</p>
        <p className="leading-[30.24px]">Additionally, users with low system experience needed an intuitive solution that could guide them through complex workflows without increasing training overhead.</p>
      </div>
    </div>
  );
}
...
function Container8() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-full" data-name="Container">
      <SectionLabel2 />
      <div className="font-['Space_Grotesk:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[16.8px] text-[rgba(255,255,255,0.7)] w-[748px]">
        <p className="leading-[30.24px] mb-0">I designed a role‑based experience that guides users through each operational flow, including document storage, digital and physical loans, extensions, and returns. Each process was broken into clear, guided steps with intuitive forms, status visibility, and structured validations.</p>
        <p className="leading-[30.24px]">The solution prioritized clarity, traceability, and flexibility—allowing administrators to control access periods, approval states, and operational rules, while maintaining a simple and accessible experience for requesters.</p>
      </div>
    </div>
  );
}
...
function Container12() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-0 pt-[26px] top-[381.34px] w-[352.017px]" data-name="Container">
...
function Section1() {
  return (
    <div className="absolute h-[862px] left-[140px] top-[1179px] w-[1184px]" data-name="Section">
      <Container3 />
      <Container10 />
    </div>
  );
  ...
  return (
    <div className="h-[95.98px] relative shrink-0 w-[572.358px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[7.997px] items-start relative size-full">
        ...
        <p className="font-['Space_Grotesk:Bold',sans-serif] font-bold leading-[72px] relative shrink-0 text-[48px] text-white tracking-[-0.96px] whitespace-nowrap">Marketplace de Vehículos</p>
      </div>
    </div>
  );
}
...
function Container17() {
  return (
    <div className="bg-[#ff6b6b] relative rounded-[30504000px] shrink-0 size-[47.997px]" data-name="Container">
...
function CaseStudy() {
  return (
    <div className="absolute bg-[#0a0a0a] h-[2415px] left-0 top-0 w-[1464px]" data-name="CaseStudy">
      <Section />
      <Container1 />
      <Section1 />
      <div className="absolute bg-[#0a0a0a] content-stretch flex flex-col h-[224.872px] items-start left-0 pt-[0.909px] px-[91.818px] top-[2091px] w-[1463.636px]" data-name="Section">
        <div aria-hidden="true" className="absolute border-[rgba(255,255,255,0.1)] border-solid border-t-[0.909px] inset-0 pointer-events-none" />
        <Button />
      </div>
    </div>
...
function Footer({ className }: { className?: string }) {
  return (
    <div className={className || "absolute content-stretch flex h-[84.886px] items-center justify-between left-[91.82px] pt-[0.909px] px-[47.997px] top-[2314.87px] w-[1280px]"} data-name="Footer">
      <div aria-hidden="true" className="absolute border-[rgba(255,255,255,0.1)] border-solid border-t-[0.909px] inset-0 pointer-events-none" />
      <Link1 />
      <Text13 />
    </div>
...
function Text15() {
  return (
    <div className="h-[20px] relative shrink-0 w-[60.014px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Space_Mono:Regular',sans-serif] leading-[20px] left-0 not-italic text-[14px] text-[rgba(255,255,255,0.3)] top-[0.09px] whitespace-nowrap">01 / 04</p>
      </div>
    </div>
  );
}
